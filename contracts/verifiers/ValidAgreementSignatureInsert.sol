...
library ValidAgreementSignatureInsert {
  ...
  uint256 constant Qmx =
    18712728095431682328920555165708503578720536242615390931328302422787168351664;
  uint256 constant Qmy =
    9820927554481180827205906206182532918252104324515098703536214092818227836274;
  uint256 constant Qlx =
    6443231394990488888915974532290686107553437533113548975791146471505049099270;
  uint256 constant Qly =
    2622060493328070356243287041462381682144936966738624967353763204036430206481;
  uint256 constant Qrx =
    20190271192438623177869390489907405915597152843566920814277734700438094277936;
  uint256 constant Qry =
    12370454588948541436366941204987771935880250944997486803626518754042458646039;
  uint256 constant Qox =
    11344881323751784933728167579379054464142597794997207147917283727999871603640;
  uint256 constant Qoy =
    17153821105360110868462024473259829159204081380593933173982693130011169653312;
  uint256 constant Qcx =
    13239067302126504612761495210555190643508536389910462939762225014740481650228;
  uint256 constant Qcy =
    6608212470406512112142003417303089618214981095511933063851103695044302781094;
  uint256 constant S1x =
    21649548658698581447994584579229471201357451004867157983046270762718337741950;
  uint256 constant S1y =
    9525331764523368728196630645193777817942933480063299971326577927488819935807;
  uint256 constant S2x =
    15192372492343126926503588254743978589648409289340072348955823708114473737645;
  uint256 constant S2y =
    4467595713917483499233923911869485975979446023679678790040945420935852044948;
  uint256 constant S3x =
    2337278348500843602168667547638877157715635672050455289299446764693532720093;
  uint256 constant S3y =
    2385631144113945276642880701771942076405044709301369788527115946077862525383;
  uint256 constant k1 = 2;
  uint256 constant k2 = 3;
  uint256 constant X2x1 =
    10488582682037661750781297609509430999478331551061055466836660583577266971779;
  uint256 constant X2x2 =
    18538588126459199519448423461269199885407697314717116557856079126429011250001;
  uint256 constant X2y1 =
    7845698553768636597455232234292454566961799076186518672372227179635059127219;
  uint256 constant X2y2 =
    13733755187430980496338714425430883807776610354203197257214389622548046362186;
